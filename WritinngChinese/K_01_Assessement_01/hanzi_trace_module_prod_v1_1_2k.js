...
(function(global){
  ...
  function mount(container, options){
    ...
    function makeLightStrip(pos){
      ...
      // 14 lights per side to wrap the entire border
      const count = 14;
      ...
      for (let i = 0; i < count; i++) {
        ...
        b.style.opacity = "0.3";
        b.style.transition = "transform 0.2s ease-out, box-shadow 0.2s ease-out, opacity 0.2s ease-out";
