...
// Auto-save to small boxes when the module reports last-stroke completion
try{
  window.addEventListener('hanzi:last-stroke-complete', function(ev){
    try{ saveToBoxes(); }catch(e){}
  });
}catch(e){}
})();
