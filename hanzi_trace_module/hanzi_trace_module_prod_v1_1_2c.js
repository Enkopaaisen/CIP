...
/* Hanzi Trace Module v1.1.2c – Fit-in-grid + Dot-toggle fix */
(function(global){
  'use strict';
  ...
  function mount(container, options){
    ...
    function layout(strokes){
      ...
      // 10% safety margin so glyph doesn't fill to edges
      const safety = 0.90;
    ...
    // Toggle visibility (fix: show only dot+label; halo off)
    ...
    // Undo/Clear/Save (same as 1.1.2b)
